...
|                         | fly.io        | Railway.app     | render.com    | glitch.com        | Adaptable.io | Cyclic.sh    | Qoddi.com |
| ----------------------- | ------------- | --------------- | ------------- | ----------------- | ------------ | ------------ | --------- |
| Shutdown for Inactivity | No            | No              | 15 minutes    | 5 minutes         | Yes*         | No           | No info   |
| Credit Card Required    | Yes           | No              | No            | No                | No           | No           | Yes       |
| Free Tier Limits        | ?             | $5 or 500 hours | 750 hours     | 1000 hours        | None*        | 100,000 req? | 3 apps    |
| RAM                     | 256MB         | 512MB           | 512MB         | 512MB             | 256MB        | 1GB          | 512MB     |
| Disk Space              | 3GB           | 1GB             |               | 200MB*            | 1GB          | 512MB*       | No info   |
| Disk Write Access       | Yes           |                 | No            | Yes               | Yes*         | Yes*         | No info   |
| Network Bandwidth       | 160GB         | 100GB           | 100GB         | 4000 req/hour     | 100GB        |              | Unmetered |
